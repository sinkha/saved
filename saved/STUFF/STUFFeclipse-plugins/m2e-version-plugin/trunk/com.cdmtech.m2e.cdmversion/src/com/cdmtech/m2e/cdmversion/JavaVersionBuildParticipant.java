 ...
 *
 */
public class JavaVersionBuildParticipant extends MojoExecutionBuildParticipant {

   /**
    * @param execution
    * @param runOnIncremental
    */
   public JavaVersionBuildParticipant(MojoExecution execution, boolean runOnIncremental) {
