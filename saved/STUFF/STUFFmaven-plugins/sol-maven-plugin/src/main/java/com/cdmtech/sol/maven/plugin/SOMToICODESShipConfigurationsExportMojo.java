...
import com.cdmtech.proj.sol.exporter.icodes.ship.icodes_ship_1_0_0.ShipConfigurationDocumentCreator;

/**
 * Exports SOM ship object to an ICODES Ship Info XML file.
 * 
 * @goal create-ship-configurations-files
 * @phase generate-resources
 * @author jundesser
 */
public class SOMToICODESShipConfigurationsExportMojo extends AbstractMojo {
   ...
   public void execute() throws MojoExecutionException {
      try {
         ...
         Document document = ShipConfigurationDocumentCreator.createDocument(view);
         export(document);
      } catch (Exception e) {
